            ...
            <Svg width={width * 0.85} height={250} viewBox="0 0 300 200">
              <G transform="translate(10, 10)">
                <ColoringPart
                  ...
                  lx="150"
                  ly="170"
                  d="M145,160 Q150,190 155,160 Q160,130 150,110 Q140,130 145,160 Z M150,110 Q145,90 150,70 Q155,90 150,110 Z"
                />
                <ColoringPart
                  id="wing_r_t"
                  label="٢"
                  lx="220"
                  ly="60"
                  d="M150,100 C170,80 230,40 260,80 C290,120 230,140 150,100 Z"
                />
                <ColoringPart
                  id="wing_r_b"
                  label="٣"
                  lx="200"
                  ly="140"
                  d="M150,100 C170,120 210,180 230,150 C250,120 210,100 150,100 Z"
                />
                <ColoringPart
                  id="wing_l_t"
                  label="٢"
                  lx="80"
                  ly="60"
                  d="M150,100 C130,80 70,40 40,80 C10,120 70,140 150,100 Z"
                />
                <ColoringPart
                  id="wing_l_b"
                  label="٣"
                  lx="100"
                  ly="140"
                  d="M150,100 C130,120 90,180 70,150 C50,120 90,100 150,100 Z"
                />
                <ColoringPart
                  id="spots"
                  label="٤"
                  lx="150"
                  ly="100"
                  d="M230,80 C240,70 240,60 230,50 C220,60 220,70 230,80 Z M70,80 C60,70 60,60 70,50 C80,60 80,70 70,80 Z"
                />
              </G>
            </Svg>
          </View>
              ...
              >
                <View
                  style={[
                    ...
                    selectedColorId === item.id && styles.activeColor,
                  ]}
                >
                ...
                <Text
                  style={[
                    styles.paletteLabel,
                    { color: selectedColorId === item.id ? item.color : MUTED },
                  ]}
                >
                  {item.label}
                </Text>

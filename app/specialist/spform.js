...
const PAGES = [
    ...
    questions: [
      {
        id: "q1",
        type: "radio",
        text: "1- يظهر الطفل تواصلاً بصرياً عند المناداة باسمه / عند اللعب معه / عند الضحك معه",
      },
      {
        id: "q2",
        type: "radio",
        text: "2- يظهر الطفل القدرة على اللعب التخيلي\n(يتظاهر بإطعام دمية / التحدث بالهاتف / تحريك سيارة / يمثل دور بابا أو ماما أو طبيب)",
      },
      {
        id: "q3",
        type: "radio",
        text: "3- هل يظهر الطفل القدرة على مطابقة الأشياء المتماثلة؟\n(مطابقة الجوارب / الأحذية المشابهة / تنسيق غطاء العلبة مع العلبة الصحيحة)",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q11",
        type: "radio",
        text: "11- هل يعرف الأشياء البسيطة في البيئة؟\n(كرسي - باب - حذاء - ملعقة - كوب - طاولة)",
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "q12",
        type: "radio",
        text: "12- هل يظهر الطفل القدرة على نسخ الخطوط؟\n(يرسم خط عمودي أو أفقي بعد أن يُرسم أمامه)",
      },
      {
        id: "q13",
        type: "radio",
        text: "13- هل يظهر الطفل القدرة على نسخ الأشكال؟\n(يرسم دائرة أو مثلث أو مربع بعد أن يُرسم أمامه)",
      },
      {
        id: "q14",
        type: "radio",
        text: "14- هل يظهر الطفل القدرة على التلوين داخل الأشكال بشكل صحيح؟",
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "q15",
        type: "radio",
        text: "15- هل يتذكر أشياء تم عرضها عليه؟\n(مكان لعبة / نشاط سابق / خطوات لعبة معينة)",
      },
      {
        id: "q16",
        type: "radio",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "q19",
        type: "radio",
        text: "19- هل يتذكر مكان أغراضه المفضلة؟\n(دمية - سيارة - حذاء)",
      },
  ...
  },
  {
    ...
    badgeText: "#7A6B10",
    btnColor: "#6BAFCF",
    questions: [{ id: "q34", type: "radio", text: "34- يندفع في الاستجابة" }],
  },
  {
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successSub}>
            تم حفظ بيانات الطفل في قاعدة البيانات.
          </Text>
          <TouchableOpacity
            style={[
              styles.nextBtn,
        ...
        {currentPageData.questions.map((q) => (
          <View key={q.id} style={styles.questionWrapper}>
            <Text
              style={[
                styles.questionText,
                errorFields.includes(q.id) && { color: "red" },
              ]}
            >
              {q.text}
            </Text>
            {q.type === "radio" ? (
                ...
                {RADIO_OPTIONS.map((opt) => (
                  ...
                  >
                    <Text
                      style={[
                        styles.radioLabel,
                        answers[q.id] === opt && styles.radioLabelSelected,
                      ]}
                    >
                      {opt}
                    </Text>
              ...
              <TextInput
                style={[
                  styles.textInput,
                  errorFields.includes(q.id) && { borderColor: "red" },
                ]}
        ...
        >
          {loading ? (
            ...
            <Text style={styles.btnText}>
              {currentPage === PAGES.length - 2 ? "إرسال وحفظ" : "التالي"}
            </Text>
          )}
        </TouchableOpacity>
      </View>

...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "في صفحة تسجيل الدخول، اضغط على \"نسيت كلمة المرور؟\"، أدخل بريدك الإلكتروني، وسيتم إرسال رابط لإعادة تعيين كلمة المرور.",
  },
  {
    question: "هل بيانات طفلي آمنة؟",
    answer:
      "نعم. نستخدم تقنيات تشفير متقدمة من Google Firebase لحماية البيانات. لا يستطيع الوصول لمعلومات طفلك سوى أنت والأخصائي المعالج.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "نعم. عند فتح بطاقة طفلك من الصفحة الرئيسية، ستجد قسم \"الخطة العلاجية\" يعرض الأهداف والجرعة العلاجية والأنشطة المخصصة.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "في الإعدادات، اضغط على \"تعديل الملف الشخصي\" لتحديث اسمك أو بريدك. لتغيير كلمة المرور، اضغط على \"تغيير كلمة المرور\".",
  },
  {
    question: "ماذا أفعل إذا واجهت مشكلة تقنية؟",
    answer:
      "تواصل معنا من خلال صفحة \"تواصل معنا\" في الإعدادات على البريد: support@namaa.app",
  },
];

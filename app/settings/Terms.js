...
const SECTIONS = [
  ...
  },
  {
    icon: "person-circle",
    title: "الأهلية",
    text: "يجب أن يكون عمرك 18 سنة فأكثر لاستخدام التطبيق. إذا كنت ولي أمر، فأنت مسؤول عن استخدام طفلك للتطبيق تحت إشرافك المباشر.",
  },
  {
    icon: "medical",
  ...
  },
  {
    icon: "alert-circle",
    title: "إنهاء الحساب",
    text: "نحتفظ بالحق في تعليق أو إنهاء أي حساب يخالف هذه الشروط. كما يمكنك إنهاء حسابك في أي وقت من خلال الإعدادات أو التواصل معنا.",
  },
  {
    icon: "refresh",
    title: "تحديث الشروط",
